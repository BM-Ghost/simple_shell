...
ssize_t getNodeIndex(List *head, List *node);
...
ssize_t readShellBuffer(ShellInfo *info, char *buffer, size_t *bufferSize);
ssize_t getShellInput(ShellInfo *info);
ssize_t inputShellBuffer(ShellInfo *info, char **buffer, size_t *bufferLength);
